                ...
                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  ...
                  : (loggedInUser === creator) && (processor) ?
                    <div className="flex">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 bi bi-check" fill="currentColor"  viewBox="0 0 16 16">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6  bi bi-hand-thumbs-down" fill="currentColor"  viewBox="0 0 16 16" >
